...
<head>
  ...
  <link href="https://fonts.bunny.net/css?family=pacifico:400,700" rel="stylesheet" />
</head>
    ...
    <header id="masthead" class="site-header">
      <div class="inside-header grid-container grid-parent">
        <div class="site-branding">
          ...
          <div class="site-logo">
            <img src="/bl-content/uploads/pages/1cffb969ff215a2d62dca5c80381a4dd/tikishack_logo.jpeg" alt="TikiShack Logo" />
          </div>
        </div>
      </div>
    </header>
